...
! function (a, b, c) {
    ...
    }(window, document), angular.module("config", []).constant("APP_NAME", "SAC APP").constant("APP_VERSION", "0.1").constant("API", "/websites/marcopolo_sac/api/").constant("ENV", "PROD"), window.appSacLocale = window.appSacLocale || {}, window.appSacLocale["app/i18n/resources-locale_en.js"] = {

...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    key: "updateThemeSetting",
    value: function updateThemeSetting(id) {
    ...
    key: "alertError",
    value: function alertError(jqXHR) {
      var _msg;
      ...
      Swal.fire({
        ...
        text: (_msg = msg) !== null && _msg !== void 0 ? _msg : this.trans('modal.error.text'),
    ...
    value: function stripTags(str) {
      return str.replace(/^\s+|\s+$/g, ''); // return str.replace(/(<([^>]+)>)/gi, '');
    }
  }, {
    key: "slugify",
    value: function slugify(str) {
      ...
      var to = 'aaaaa--eeeeeiiiiooooouuuunc------';
    ...
    key: "formValidate",
    value: function formValidate(form, errorPlacement, rules, messages) {
      var $form = $(form);
      var config = {
        focusInvalid: false,
        ignore: null,
        errorPlacement: errorPlacement !== null && errorPlacement !== void 0 ? errorPlacement : function (error, element) {
          error.addClass('invalid-feedback');
          error.insertAfter(element);
        },
        invalidHandler: function invalidHandler(f, v) {
          try {
            var firstInvalidElement = $(v.errorList[0].element);
            firstInvalidElement.trigger('focus');
            $('html,body').scrollTop(firstInvalidElement.offset().top - 200);
            var detail = firstInvalidElement[0].closest('details');
    ...
    value: function ckeditor() {
      var className = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.ckeditor';
      ...
      var plugins = [];
      if (route != null) plugins.push(MyCustomUploadAdapterPlugin);
      var editors = {};
...
$(function () {
  window.app = new App(); // Necessário para alguns componentes

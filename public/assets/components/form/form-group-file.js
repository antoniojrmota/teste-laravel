...
"use strict";
/*!*************************************************************!*\
  !*** ./resources/assets/components/form/form-group-file.js ***!
  \*************************************************************/
...
var FormGroupFile = /*#__PURE__*/function () {
  function FormGroupFile() {
    _classCallCheck(this, FormGroupFile);

    this.init();
  }

  _createClass(FormGroupFile, [{
    key: "init",
    value: function init() {
      $(".input-file").on("change", function () {
        ...
        if (fileList.length) {
          ...
          changeButton = true; // Informa que pode ser removido o arquivo anterior
        ...
        if (changeButton) {
          $btn.removeClass("btn-primary").addClass("btn-danger").html(app.trans("fileInput.remove"));
          $btn.on("click", function (e) {
            ...
            Swal.fire({
              ...
              if (action.isConfirmed) {
                ...
                $input.data("old", 0);
                $input.val(""); // Numa edição pode ser necessário solicitar o campo novamente

                if ($btn.data("force-required") == 1) $input.prop("required", true);
                $input.trigger("change"); // Informa que pode ser removido o arquivo anterior
